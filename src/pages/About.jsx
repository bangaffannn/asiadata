    ...
    <section id='about' className="mt-10 mb-20">
      <div className="container mx-auto">
        ...
        <div className="gap-x-2 grid grid-cols-1 md:grid-cols-2 flex justify-center items-center">
          <img src={Img1} alt="" />
          <div className="/">
            <h1 className="text-lg font-bold text-justify mb-2 text-accent">Sebanyak 97.3% pengguna internet di Indonesia menggunakan GOOGLE SEARCH</h1>
            ...
            <h1 className="text-lg font-bold text-justify mb-2 text-accent">Jadi bisnis nomor satu di tingkat lokal dengan optimalisasi LOKAL SEO yang dapat meningkatkan potensi pasar kamu lebih dari 400%</h1>
            <p className="text-justify">Dengan layanan optimalisasi SEO LOKAL kami, bisnis Anda memiliki kesempatan untuk mendominasi pasar lokal dengan peningkatan potensi lebih dari 400%. Kami menghadirkan strategi SEO yang terukur dan terbukti efektif, membantu bisnis Anda menjadi pilihan nomor satu di komunitas lokal Anda. Dengan fokus pada peningkatan visibilitas dan daya tarik di tingkat lokal, kami memberikan solusi yang dapat membantu bisnis Anda mencapai tingkat pertumbuhan yang luar biasa.</p>
          </div>
        </div>
      </div>
    </section>
